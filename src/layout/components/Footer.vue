  ...
  <footer class="app-background relative w-full bg-light-elevatedSurface text-light-secondary text-center mt-48 block">
    <div class="w-full flex flex-col justify-center">
      ...
      <div class="flex space-x-2 justify-center text-lg mt-2 pb-25">
        <a href="https://github.com/nmcodes" title="Github" class="social-media-link relative flex flex-col items-center">
        ...
        <a href="https://twitter.com/mulume_" title="Twitter" class="social-media-link relative flex flex-col items-center">
        ...
        <a href="https://www.linkedin.com/in/themarcba" title="LinkedIn" class="social-media-link relative flex flex-col items-center">
