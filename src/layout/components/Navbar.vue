  ...
  <div class="navbar space_between flex mr-10">
    ...
    <div class="right-menu mr-40 justify-center vertical-middle flex align-items">
      <button class="theme-switch-button" @click="toggleTheme">
        <svg v-if="!!theme" class="svg-theme-size mb-svg-theme" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
