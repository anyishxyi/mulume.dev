<template>
	<div class="about_page m-0 w-content">
      ...
      <div class="profile-width">
        <figure>
          <el-image :src=jeanpaul class="profile-about-pic" alt="Profile picture of Jean-Paul NGALULA (very handsome)" lazy />
        </figure>
      </div>
      <div class="bio">
		...
		<div class="content">
			...
			<ul class="skills">
				<li>
					<el-image :src=angular lazy />
				</li>
				<li>
					<el-image :src=docker lazy />
				</li>
				<li>
					<el-image :src=expressjs lazy />
				</li>
				<li>
					<el-image :src=firebase lazy />
				</li>
				<li>
					<el-image :src=java lazy />
				</li>
				<li>
					<el-image :src=javascript lazy />
				</li>
				<li>
					<el-image :src=jest lazy />
				</li>
				<li>
					<el-image :src=junit lazy />
				</li>
				<li>
					<el-image :src=jwt lazy />
				</li>
				<li>
					<el-image :src=karma lazy />
				</li>
				<li>
					<el-image :src=mocha lazy />
				</li>
				<li>
					<el-image :src=mongodb lazy />
				</li>
				<li>
					<el-image :src=mysql lazy />
				</li>
				<li>
					<el-image :src=nodejs lazy />
				</li>
				<li>
					<el-image :src=spring lazy />
				</li>
				<li>
					<el-image :src=sql lazy />
				</li>
				<li>
					<el-image :src=vuejs lazy />
				</li>
			</ul>
			<hr>
			...
			<div class="languages">
				<div class="language flex">
					...
					<div class="content"> Mothertongue</div>
				</div>
				<div class="language flex">
					<div class="title">English 🇬🇧</div>
					<div class="content"> Bilingual</div>
				</div>
			</div>
			...
			<div class="interests">
				...
				<div class="interest">
					...
					<div class="content">I'm fascinated by technological advances which companies such as Tesla, SpaceX, Boston Dynamics make.</div>
				</div>
				<div class="interest">
					<div class="title">Startups & Companies</div>
					<div class="content">I have a big entrepreneurial and startup curiosity which is devided in two fields. On one hand, small companies which try to make it big such as Avena (Mexican-originated fitness app). On the other hand, I like following strategic moves and happenings in big players such as Facebook, Netflix, Spotify.</div>
				</div>
				<div class="interest">
					<div class="title">Coding</div>
					<div class="content">This is a classic cliché. After (or before) work, I enjoy some coding on the side. I am currently exploring Nuxt and diving deeping in the internal workings of Vue.js in order to be able to contribute to the projects.</div>
				</div>
				<div class="interest">
					<div class="title">Cinema & TV</div>
					<div class="content">I love almost any kind of movie, but I always prefer DC and Marvel movies. As of TV: I enjoy my sitcoms like F·R·I·E·N·D·S (all-time favorite), HIMYM, TBBT as well as superhero-themed shows (Flash, Arrow), dramas (Dexter, Breaking Bad, GoT), among others. (If you want to engange in lengthy conversations with me, these are the way to go.)</div>
				</div>
			</div>
		</div>
	</div>
...
const angular = require('@/assets/images/skills/angular.png')
const docker = require('@/assets/images/skills/docker.png')
const expressjs = require('@/assets/images/skills/expressjs.png')
const firebase = require('@/assets/images/skills/firebase.png')
const java = require('@/assets/images/skills/java.png')
const javascript = require('@/assets/images/skills/javascript.png')
const jest = require('@/assets/images/skills/jest.png')
const junit = require('@/assets/images/skills/junit.png')
const jwt = require('@/assets/images/skills/jwt.png')
const karma = require('@/assets/images/skills/karma.png')
const mocha = require('@/assets/images/skills/mocha.jpeg')
const mongodb = require('@/assets/images/skills/mongodb.jpg')
const mysql = require('@/assets/images/skills/mysql.jpeg')
const nodejs = require('@/assets/images/skills/nodejs.jpeg')
const spring = require('@/assets/images/skills/spring.png')
const sql = require('@/assets/images/skills/sql.png')
const vuejs = require('@/assets/images/skills/vuejs.jpeg')
